...
public class RequestPerformer extends Behaviour{
  ...
  //private BookBuyerGui this_agent = this;
    ...
    case 3:      
      ...
      if (reply != null) {
         if (reply.getPerformative() == ACLMessage.INFORM) {
            System.out.println(bookTitle+" satisfactoriamente comprado del agente "+reply.getSender().getName());
            System.out.println("Price = "+bestPrice);
            JOptionPane.showMessageDialog(null,"El libro con titulo "+bookTitle+" se compro Correctamente");
            myAgent.doDelete();
         }
         else {
            System.out.println("Intento fallido: el libro requerido ya ha sido vendido.");
         }
  ...
  public boolean done() {
    if (step == 2 && bestSeller == null) {
       System.out.println("Intento Fallido: "+bookTitle+" aun no disponible para la venta");
    }
